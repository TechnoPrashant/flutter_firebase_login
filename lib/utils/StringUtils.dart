class StringUtils {
  ...
  String txtForgetPassword = 'Forget password?';
  String labelSociaLogin = 'Or login using social media.';
  String labelSociaAccount = 'Or signup using social media.';
  String lableNoaccount = 'Dont have an account? ';
  String labelCreate = 'Create';
  String retrunPassword = "Password required minimum 6 characters";
  ...
  String messageSuccess = 'Signup succesfully';
